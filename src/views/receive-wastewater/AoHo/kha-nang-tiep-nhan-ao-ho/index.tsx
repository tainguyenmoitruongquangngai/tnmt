...
import KhaNangTiepNhanAoHoBang from './Kha-nang-tiep-nhan-ao-ho-Bang'
import dynamic from 'next/dynamic';
...
const KhaNangTiepNhanAoHoDetails = () => {
  //Init columnTable
  ...
  return (
    <Grid container spacing={2}>
      ...
      <Grid xs={12} md={12}>
       <KhaNangTiepNhanAoHoBang/>
      </Grid>
    </Grid>
  )
}

export default KhaNangTiepNhanAoHoDetails
