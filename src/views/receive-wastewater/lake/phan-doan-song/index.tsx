...
import PhanDoanSongTiepNhanNuocThai from './Phan_doan_song_page'
import dynamic from 'next/dynamic';
...
const PhanDoanSongTiepNhanNuocThaiPages = () => {
  //Init columnTable
...
export default PhanDoanSongTiepNhanNuocThaiPages