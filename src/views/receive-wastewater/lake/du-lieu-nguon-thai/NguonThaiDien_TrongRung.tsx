...
const NguonThaiDien_TrongRung = () => {
  return (
    <Grid>
    <Grid className='_text_center'>
      <Typography className='font-weight-bold' sx={{ mt: 3 }} variant='h6'>
      THỐNG KÊ TẢI LƯỢNG CHẤT Ô NHIỄM TỪ NGUỒN THẢI TRỒNG RỪNG TỈNH QUẢNG NGÃI
      </Typography>
    </Grid>
    ...
    <TableContainer component={Paper} sx={{ mt: 5 }}>
      ...
      <TableHead className='tableHead'>
          <TableRow>
            ...
            <TableCell size='small' align='center' rowSpan={2}>
              Diện tích trồng rừng <br /> (ha) 
            </TableCell>
            <TableCell size='small' align='center' rowSpan={2}>
            Hệ số suy giảm dọc đường <br /> hay hệ số dòng chảy
            </TableCell>
            <TableCell size='small' align='center' colSpan={7}>
            TẢI LƯỢNG Ô NHIỄM (PLU) NGUỒN THẢI DIỆN (TRỒNG RỪNG) <br /> (g/ha/ngày)
              </TableCell>
              <TableCell size='small' align='center' colSpan={7}>
              TẢI LƯỢNG THÔNG SỐ CHẤT LƯỢNG NƯỚC CÓ TRONG NGUỒN THẢI DIỆN (TRỒNG RỪNG) <br /> Lt_dien_trong_rung (kg/ngày) 
              </TableCell>
...
export default NguonThaiDien_TrongRung
