...
const NguonThaiDien_SinhHoat = () => {
  return (
    <Grid>
    <Grid className='_text_center'>
      <Typography className='font-weight-bold' sx={{ mt: 3 }} variant='h6'>
      THỐNG KÊ TẢI LƯỢNG CHẤT Ô NHIỄM TỪ SINH HOẠT DÂN CƯ XẢ VÀO ĐOẠN SÔNG SUỐI TỈNH QUẢNG NGÃI
      </Typography>
    </Grid>
    ...
    <TableContainer component={Paper} sx={{ mt: 5 }}>
      ...
      <TableHead className='tableHead'>
          <TableRow>
            ...
            TẢI LƯỢNG Ô NHIỄM (PLU) NGUỒN THẢI DIỆN (SINH HOẠT) <br /> (g/người/ngày)
              </TableCell>
              <TableCell size='small' align='center' colSpan={7}>
              TẢI LƯỢNG THÔNG SỐ CHẤT LƯỢNG NƯỚC CÓ TRONG NGUỒN THẢI DIỆN (SINH HOẠT) <br /> Lt_dien_sinhhoat (kg/ngày) 
              </TableCell>
...
export default NguonThaiDien_SinhHoat
