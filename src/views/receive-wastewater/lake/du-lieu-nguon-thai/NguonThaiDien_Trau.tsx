...
const NguonThaiDien_Trau = () => {
  return (
    <Grid>
    <Grid className='_text_center'>
      <Typography className='font-weight-bold' sx={{ mt: 3 }} variant='h6'>
      THỐNG KÊ TẢI LƯỢNG CHẤT Ô NHIỄM TỪ NGUỒN THẢI CHĂN NUÔI GIA SÚC (TRÂU, BÒ ) XẢ VÀO ĐOẠN SÔNG SUỐI TỈNH QUẢNG NGÃI
      </Typography>
    </Grid>
    ...
    <TableContainer component={Paper} sx={{ mt: 5 }}>
      ...
      <TableHead className='tableHead'>
          <TableRow>
            ...
            <TableCell size='small' align='center' rowSpan={2}>
              Số con trâu, bò <br /> (con) 
            </TableCell>
            <TableCell size='small' align='center' rowSpan={2}>
            Hệ số suy giảm dọc đường <br /> hay hệ số dòng chảy
            </TableCell>
            <TableCell size='small' align='center' colSpan={7}>
            TẢI LƯỢNG Ô NHIỄM (PLU) NGUỒN THẢI DIỆN (TRÂU, BÒ, LỢN,...) <br /> (g/con/ngày)
              </TableCell>
              <TableCell size='small' align='center' colSpan={7}>
              TẢI LƯỢNG THÔNG SỐ CHẤT LƯỢNG NƯỚC CÓ TRONG NGUỒN THẢI DIỆN (CHĂN NUÔI GIA SÚC) <br /> Lt_dien_gia_suc (kg/ngày) 
              </TableCell>
...
export default NguonThaiDien_Trau
