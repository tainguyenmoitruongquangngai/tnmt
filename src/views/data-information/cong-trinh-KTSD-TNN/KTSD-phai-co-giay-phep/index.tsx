...
import KTNMPhaiCoGiayPhep from "./KTNM-phai-co-giay-phep";
import KTNBIENPhaiCoGiayPhep from "./KTNBIEN-phai-co-giay-phep";
import KTNDDPhaiCoGiayPhep from "./KTNNDD-phai-co-giay-phep";
